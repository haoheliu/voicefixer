| :warning: This repository is no longer being actively maintained. Please check out [this fork](https://github.com/voicefixer/voicefixer) for an actively maintained version with several fixes and improvements, including MP3 support, Apple Silicon support, and a progress bar.
| ---
